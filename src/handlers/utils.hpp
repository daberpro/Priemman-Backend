...
inline std::int64_t ParsePageSize(const userver::server::http::HttpRequest &request) {
...
inline std::int64_t ParseOffset(const userver::server::http::HttpRequest &request) {
